...
2. **Эмбеддинги + реранкинг** поверх лексического поиска: реализованы как
   опция `SO_RAG_MODE=hybrid` (см. ADR-003); переключение дефолта — по
   метрикам после роста корпуса.
